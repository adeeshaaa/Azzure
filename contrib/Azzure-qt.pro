...
RESOURCES += src/qt/Azzure.qrc src/qt/Azzure_locale.qrc

TRANSLATIONS += src/qt/locale/Azzure_bg.ts \
                src/qt/locale/Azzure_de.ts \
                src/qt/locale/Azzure_en.ts \
                src/qt/locale/Azzure_es.ts \
                src/qt/locale/Azzure_fi.ts \
                src/qt/locale/Azzure_fr.ts \
                src/qt/locale/Azzure_it.ts \
                src/qt/locale/Azzure_ja.ts \
                src/qt/locale/Azzure_pl.ts \
                src/qt/locale/Azzure_pt.ts \
                src/qt/locale/Azzure_ru.ts \
                src/qt/locale/Azzure_sk.ts \
                src/qt/locale/Azzure_sv.ts \
                src/qt/locale/Azzure_vi.ts \
                src/qt/locale/Azzure_zh_CN.ts \
                src/qt/locale/Azzure_zh_TW.ts
