...
std::string LicenseInfo()
{
    return FormatParagraph(strprintf(_("Copyright (C) 2009-%i The Bitcoin Core Developers"), COPYRIGHT_YEAR)) + "\n" +
           ...
           "\n" +
           FormatParagraph(_("Copyright (C) 2018 The Azzure Core Developers")) + "\n" +
           "\n" +
...
// ********************************************************* Step 8: load wallet
    ...
    nAnonymizeAzzureAmount = GetArg("-anonymizeAzzureamount", 0);
    if (nAnonymizeAzzureAmount > 999999) nAnonymizeAzzureAmount = 999999;
    if (nAnonymizeAzzureAmount < 2) nAnonymizeAzzureAmount = 2;
