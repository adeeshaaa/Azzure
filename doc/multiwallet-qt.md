...
In order to support loading of multiple wallets in Azzure-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is Azzure.cpp.
...
Changes to Azzure.cpp
----------------------
Azzure.cpp is the entry point into Azzure-qt, and as such, will require some minor modifications to provide hooks for
