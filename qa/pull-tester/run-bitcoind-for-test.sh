...
#
DATADIR="/home/edson/Azzurerenamed/.Azzure"
rm -rf "$DATADIR"
...
"/home/edson/Azzurerenamed/src/Azzured.exe" -connect=0.0.0.0 -datadir="$DATADIR" -rpcuser=user -rpcpassword=pass -listen -keypool=3 -debug -debug=net -logtimestamps -checkmempool=0 -relaypriority=0 -port=$PORT -whitelist=127.0.0.1 -regtest -rpcport=`expr $PORT + 1` &
BITCOIND=$!
